namespace Biltong {
    ...
    function pointHelper(p1:PointRepresentation, p2:PointRepresentation, fn:(p1:PointArray, p2:PointArray)=> number):number {
     ...
     */
    export function gradient(p1:PointRepresentation, p2:PointRepresentation):number {
     ...
     */
    export function normal(p1:PointRepresentation, p2:PointRepresentation):number  {
     ...
     */
    export function lineLength(p1:PointRepresentation, p2:PointRepresentation):number {
     ...
     */
    export function quadrant(p1:PointRepresentation, p2:PointRepresentation):Quadrant {
     ...
     */
    export function theta(p1:PointRepresentation, p2:PointRepresentation):number {
        return pointHelper(p1, p2, (_p1:PointArray, _p2:PointArray) => {
     ...
     */
    export function encloses(r1:Rectangle, r2:Rectangle, allowSharedEdges?:boolean):boolean {
        let x1 = r1.x, x2 = r1.x + r1.w, y1 = r1.y, y2 = r1.y + r1.h,
            a1 = r2.x, a2 = r2.x + r2.w, b1 = r2.y, b2 = r2.y + r2.h,
     ...
     */
    export function pointOnLine(fromPoint:Point, toPoint:Point, distance:number):Point {
     ...
     */
    export function perpendicularLineTo(fromPoint:Point, toPoint:Point, length:number):Line {
        let m = gradient(fromPoint, toPoint),
